...
<meta charset="UTF-8">
   	<link
   		rel="stylesheet" href="${pageContext.servletContext.contextPath}/static/css/client/KS_CSS/Header.css">
	<link 
		rel="stylesheet" href="${pageContext.servletContext.contextPath}/static/css/client/KS_CSS/AsideButton.css">
   	<link 
   		rel="stylesheet" href="${pageContext.servletContext.contextPath}/static/css/client/KS_CSS/nndi-style.css">
 	<link 
 		rel="stylesheet" href="${pageContext.servletContext.contextPath}/static/css/client/KS_CSS/sidebars.css">
    <link 
...
<body>
	...
	<div>
    	<img 
    		src="${pageContext.servletContext.contextPath}/static/image/client/main_header.PNG" class="nndi-logo" 
